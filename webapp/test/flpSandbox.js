		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "eCompliance",
									"targetURL": "#techtaxeraappecompliance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"techtaxeraappecompliance-display": {
								"semanticObject": "techtaxeraappecompliance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tech.taxera.app.ecompliance",
									"url": sap.ui.require.toUrl("tech/taxera/app/ecompliance")
								}
							}
						}
					}
